...
def tik():
    ...
    for o in titik:
        ...
        print '\r\x1b[1;91m     [\xe2\x97\x8f] \x1b[1;92mWait Few Minutes \x1b[1;97m' + o,
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
    	...
    	password = raw_input("\033[1;97m\x1b[1;97mTool Password  \x1b[1;97m------- \x1b[1;97m")        if (password == CorrectPassword):
        ...
        os.system('xdg-open https://youtu.be/JUrGfYpGzrs')
...
def login():
    ...
    print '\x1b[1;95m(1) TDF Pakistan Id  Cloning'

    print '\x1b[1;92m(2) TDF Bangladesh Cloning'
